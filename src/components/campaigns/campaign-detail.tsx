...
export function CampaignDetail({ id }: { id: string }) {
  ...
  async function copyLink(link: DistributionLink) { await navigator.clipboard.writeText(`${window.location.origin}/f/${form.public_id}?ref=${link.link_token}`); setCopied(link.channel) }
