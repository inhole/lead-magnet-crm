...
type Campaign = { id: string; name: string; published_at: string | null; campaign_forms: Array<{ public_id: string; title: string; description: string; submit_label: string; html_templates: { name: string } | null }> }
